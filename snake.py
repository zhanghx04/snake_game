...
while True:
    ...
    if head_pos[0] < 0:     # most left
        head_pos[0] = frame_size_x - square_size
    elif head_pos[0] > frame_size_x - square_size:  # most right
        head_pos[0] = 0
    elif head_pos[1] < 0:   # most up
        head_pos[1] = frame_size_y - square_size
    elif head_pos[1] > frame_size_y - square_size:  # most down
        head_pos[1] = 0
